  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative overflow-x-hidden">
      ...
      <section ref={heroRef} className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 py-10 md:py-24">
        ...
        >
          <div className="w-full max-w-[200px] sm:max-w-xs mx-auto -mb-8" style={{ height: "180px" }}>
            <Suspense fallback={<OwlMascot size="xl" trackMouse />}>
              <OwlScene equippedItems={{}} />
            </Suspense>
          </div>

          <p className="text-base sm:text-lg md:text-xl font-display font-semibold text-foreground/80 -mt-2">
